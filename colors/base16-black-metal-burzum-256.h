// Base16 Black Metal (Burzum) dark - simple terminal color setup
// metalelf0 (https://github.com/metalelf0)
static const char *colorname[] = {
	/* Normal colors */
	"#000000", /*  0: Base 00 - Black   */
	"#5f8787", /*  1: Base 08 - Red     */
	"#ddeecc", /*  2: Base 0B - Green   */
	"#99bbaa", /*  3: Base 0A - Yellow  */
	...
	"#ddeecc", /* 10: Base 0B - Green        */
	"#99bbaa", /* 11: Base 0A - Yellow       */
