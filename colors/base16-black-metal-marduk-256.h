// Base16 Black Metal (Marduk) dark - simple terminal color setup
// metalelf0 (https://github.com/metalelf0)
static const char *colorname[] = {
	/* Normal colors */
	"#000000", /*  0: Base 00 - Black   */
	"#5f8787", /*  1: Base 08 - Red     */
	"#a5aaa7", /*  2: Base 0B - Green   */
	"#626b67", /*  3: Base 0A - Yellow  */
	...
	"#a5aaa7", /* 10: Base 0B - Green        */
	"#626b67", /* 11: Base 0A - Yellow       */
