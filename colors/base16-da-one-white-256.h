// Base16 Da One White dark - simple terminal color setup
...
static const char *colorname[] = {
	...
	"#de5d6e", /*  9: Base 08 - Red          */
	"#76a85d", /* 10: Base 0B - Green        */
	"#b3684f", /* 11: Base 0A - Yellow       */
	"#5890f8", /* 12: Base 0D - Blue         */
	"#c173d1", /* 13: Base 0E - Magenta      */
	"#64b5a7", /* 14: Base 0C - Cyan         */
