// Base16 Black Metal (Bathory) dark - simple terminal color setup
// metalelf0 (https://github.com/metalelf0)
static const char *colorname[] = {
	/* Normal colors */
	"#000000", /*  0: Base 00 - Black   */
	"#5f8787", /*  1: Base 08 - Red     */
	"#fbcb97", /*  2: Base 0B - Green   */
	"#e78a53", /*  3: Base 0A - Yellow  */
	...
	"#fbcb97", /* 10: Base 0B - Green        */
	"#e78a53", /* 11: Base 0A - Yellow       */
