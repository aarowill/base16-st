// Base16 Eva dark - simple terminal color setup
// kjakapat (https://github.com/kjakapat)
static const char *colorname[] = {
	/* Normal colors */
	"#2a3b4d", /*  0: Base 00 - Black   */
	"#c4676c", /*  1: Base 08 - Red     */
	"#66ff66", /*  2: Base 0B - Green   */
	"#ffff66", /*  3: Base 0A - Yellow  */
	"#15f4ee", /*  4: Base 0D - Blue    */
	...
	"#66ff66", /* 10: Base 0B - Green        */
	"#ffff66", /* 11: Base 0A - Yellow       */
	"#15f4ee", /* 12: Base 0D - Blue         */
