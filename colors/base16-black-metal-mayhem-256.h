// Base16 Black Metal (Mayhem) dark - simple terminal color setup
// metalelf0 (https://github.com/metalelf0)
static const char *colorname[] = {
	/* Normal colors */
	"#000000", /*  0: Base 00 - Black   */
	"#5f8787", /*  1: Base 08 - Red     */
	"#f3ecd4", /*  2: Base 0B - Green   */
	"#eecc6c", /*  3: Base 0A - Yellow  */
	...
	"#f3ecd4", /* 10: Base 0B - Green        */
	"#eecc6c", /* 11: Base 0A - Yellow       */
