// Base16 Black Metal (Dark Funeral) dark - simple terminal color setup
// metalelf0 (https://github.com/metalelf0)
static const char *colorname[] = {
	/* Normal colors */
	"#000000", /*  0: Base 00 - Black   */
	"#5f8787", /*  1: Base 08 - Red     */
	"#d0dfee", /*  2: Base 0B - Green   */
	"#5f81a5", /*  3: Base 0A - Yellow  */
	...
	"#d0dfee", /* 10: Base 0B - Green        */
	"#5f81a5", /* 11: Base 0A - Yellow       */
