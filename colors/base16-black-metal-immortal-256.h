// Base16 Black Metal (Immortal) dark - simple terminal color setup
// metalelf0 (https://github.com/metalelf0)
static const char *colorname[] = {
	/* Normal colors */
	"#000000", /*  0: Base 00 - Black   */
	"#5f8787", /*  1: Base 08 - Red     */
	"#7799bb", /*  2: Base 0B - Green   */
	"#556677", /*  3: Base 0A - Yellow  */
	...
	"#7799bb", /* 10: Base 0B - Green        */
	"#556677", /* 11: Base 0A - Yellow       */
